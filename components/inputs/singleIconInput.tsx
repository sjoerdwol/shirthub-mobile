...
export default function SingleIconInput({ firstIcon, keyboardType, onChangeText, placeholder, value }: InputProps) {
  return (
    <View className="relative">
      <Ionicons className="absolute left-4 top-1/2 -translate-y-1/2 z-50" name={firstIcon as React.ComponentProps<typeof Ionicons>["name"]} color='rgb(141 157 180)' size={16} />
      <TextInput
